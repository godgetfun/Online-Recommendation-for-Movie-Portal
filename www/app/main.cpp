...
void suggest(LL x)
{
	...
	REP(j,l)
	{
		REP(k,data[similarPeople[j]].size())
		{
			...
			// number of top 5 matching genres of our watched movies..
			...
			// number of Maximum matching top genre=3 then 2 then 1
